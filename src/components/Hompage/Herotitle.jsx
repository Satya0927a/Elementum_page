...
const Herotitle = () => {
  return (
    <div className=" w-333 max-xl:w-full max-xl:px-8 m-auto flex flex-col items-center mt-20 max-xl:mt-10 gap-5">
      <h1 className="font-ghibli text-[100px]/[126px] max-xl:text-[56px]/[72px] relative max-w-[1305px] max-xl:max-w-full text-center text-pretty font-[400]">The thinker and <br/> doer were changing the status quo with
      ...
      <p className=" w-215 max-xl:w-full max-xl:px-6 text-[22px]/[36px] max-xl:text-[18px]/[28px] text-pretty text-center">We are a team of strategists, designers communicators, researchers. Togeather,
