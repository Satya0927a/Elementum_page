...
const Features = () => {
  ...
  return (
    <div className="flex flex-col gap-50 max-xl:gap-25 max-w-[1599px] max-xl:max-w-full max-xl:px-8 m-auto" >
      ...
      <img src={triangle} className="absolute left-20 bottom-140 z-[-1] max-sm:scale-50 max-sm:left-50 max-sm:bottom-120 " alt="" srcset="" />
      <img src={triangle} className="absolute left-140 bottom-50 " alt="" srcset="" />
      <img src={titledrectangle} className="absolute right-20 top-10 z-[-1] max-sm:scale-50 max-sm:right-0" alt="" srcset="" />"
    </div>
  )
}
